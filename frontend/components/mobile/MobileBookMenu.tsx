...
const MobileBookMenu: React.FC<MobileBookMenuProps> = ({
  ...
  const [progressValue, setProgressValue] = useState(reading.progress_pages?.toString() || '0')
  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className="fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-xl shadow-xl border-t border-gray-200 max-h-[80vh] overflow-y-auto"
      >
        {/* Header */}
        ...
        <div className="p-4 space-y-6">
          ...
          {reading.status === 'currently_reading' && (
            <div>
              <h4 className="text-sm font-medium text-gray-900 mb-3">Reading Progress</h4>
              {!showProgressInput ? (
                <button
                ...
                >
                  ...
                  <span className="text-sm text-gray-600">
                    {reading.progress_pages || 0} pages
                  </span>
                </button>
              ) : (
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    {reading.total_pages && (
                      <span className="text-sm text-gray-600">/ {reading.total_pages}</span>
                    )}
                  </div>
                  <div className="flex space-x-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        setShowProgressInput(false)
                        setProgressValue(reading.progress_pages?.toString() || '0')
                      }}
                      className="flex-1"
                    >
                      Cancel
